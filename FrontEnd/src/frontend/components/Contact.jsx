...
import "../css-assets/ContactUs.css"; // Import CSS file
...
function Contact() {
  ...
  const handleJobSelection = (event) => {
    ...
    setShowDescription(true); // Resetting showDescription when a new job is selected
  };
    ...
    <Container className="contact-container">
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Row className="mb-3">
          ...
          {selectedOption === "Career" && (
            <div>
              ...
              {selectedJob !== "" && ( // Render the button only if a job is selected
                <Button
        ...
        <div>
          <Row
            className="mb-3"
            style={{ display: selectedOption === "Career" ? "none" : "block" }}
          >
        ...
        >
          ...
          <Modal.Body>
            Are you sure the all details are filled and correct?
          </Modal.Body>
          <Modal.Footer>
